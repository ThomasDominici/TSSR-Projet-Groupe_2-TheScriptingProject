...
#        intÃ©ragir depuis un serveur      # 
#    vers diffÃ©rent client avec des OS    # 
#              diffÃ©rent                  #
...
function newUser { Invoke-command -computername cliwin -Credential thomas -scriptblock { $newUser = Read-Host "Merci de renseigner un nom d'utilisateur à ajouter"
If ($newUser)
{
        ...
        while ($true)
            {
               ...
               $choixSecondaire=Read-Host -Prompt "Choisissez 1 ou 2"
                   ...
                   switch ($choixSecondaire)
                        ...
                        * 
                            {
                            Write-Host "Veuillez saisir un chiffre entre 1 et 10"
                            }
                        }
                    }
             }              
                ...
                $choixSecondaire=Read-Host -Prompt "Choisissez 1 ou 2"
                 while ($true) 
                   ...
                   switch ($choixSecondaire)
                        ...
                        1
                            {
                            Write-Host "1 -- Voulez-vous savoir la derniÃ¨re date de connection d'un Utilisateur ?"
                            Write-Host "2 -- Voulez-vous savoir la derniÃ¨re date de modification du mot de passe d'un Utilisateur ?"
                        ...
                        2
                            ...
                            Write-Host "3 -- Voulez-vous savoir la taille d'un rÃ©pertoire spÃ©cifique de la machine ?"
                            ...
                            Write-Host "7 -- Voulez-vous savoir la liste des applications installÃ© sur la machine ?"
                            Write-Host "8 -- Voulez-vous savoir les spÃ©cificitÃ© du CPU sur la machine ?"
                            Write-Host "9 -- Voulez-vous savoir la mÃ©moire RAM total sur la machine ?"
                            ...
                            $ChoixTerciaire=Read-Host -Prompt "Choisir entre 1 et 12}"
                                    ...
                                    while ($true)
                                {
                                    switch ($ChoixTerciaire)
                                        ...
                                        * 
                                            {
                                            Write-Host "Veuillez saisir un nombre entre 1 et 12"
                                            }
                                        }
                                   }
                            }
